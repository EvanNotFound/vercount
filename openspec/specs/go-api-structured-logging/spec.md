...
Define the structured logging behavior for the public Go events service, including production formatting, local readability, request observability, and operational event consistency.
