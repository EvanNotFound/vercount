...
Define how the React package is maintained inside the monorepo, resolved by the web app, documented for contributors, and integrated with the shared browser counter core.
...
- **WHEN** `useVercount` retrieves counter data in the browser from `@vercount/react`
