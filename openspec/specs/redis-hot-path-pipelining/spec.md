...
Define Redis hot-path pipelining expectations for the Go public events service so it can batch independent commands on rate-limit and counter paths without changing existing counter behavior or over-abstracting the implementation.
