...
export default function Usage() {
  return (
    <section
      id="usage"
      className="w-full py-20 md:py-32 border-b border-white/10"
    >
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-zinc-400">选择适合你的 Web 框架</p>
        </div>
        ...
        <div className="flex flex-col gap-8 max-w-5xl mx-auto">
          <Tabs defaultValue="html" className="w-full">
            <TabsList className="grid grid-cols-2 bg-white/5 text-white w-fit border border-border h-fit mx-auto">
              <TabsTrigger
                value="html"
                className="w-fit px-4 py-2 data-[state=active]:bg-white/10 data-[state=active]:text-white flex items-center gap-2"
              >
      ...
      <h2>Unique Visitors: {siteUv}</h2>
                  ...
                  <div className="mt-2 space-y-2">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-zinc-300">
                      <li>
                        <span className="font-mono text-blue-400">sitePv</span>:
                        The total number of page views across the entire
                        website.
                      </li>
                      <li>
                        <span className="font-mono text-blue-400">pagePv</span>:
                        The number of page views on the current page.
                      </li>
                      <li>
                        <span className="font-mono text-blue-400">siteUv</span>:
