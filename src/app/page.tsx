...
import { ArrowRight,Zap, Globe, Shield, RefreshCw, Code, Database } from "lucide-react";
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col items-center text-center gap-8 max-w-3xl mx-auto">
              <div className="space-y-4">
                <h1 className="text-4xl md:text-8xl font-bold tracking-tighter">Vercount</h1>
                ...
                <p className="text-lg text-zinc-500 leading-normal">
                  网站流量计数器，简单、快速、可靠<br />不蒜子计数器完美替代方案
                </p>
              </div>
